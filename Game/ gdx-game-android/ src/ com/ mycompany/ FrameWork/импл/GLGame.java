...
import com.mycompany.FrameWork.Audio;
import com.mycompany.FrameWork.FileIO;
import com.mycompany.FrameWork.Game;
import com.mycompany.FrameWork.Graphics;
...
public abstract class GLGame extends Activity implements Game,Renderer
{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		input = new AndroidInput( glView, 1, 1);
		...
		if(isFinishing()) state = GLGameState.Finished;
			...
			while(true) {
				try {
					...
					wakeLock.release(); glView.onPause(); super.onPause();}
	...
	@Override public Graphics getGraphics() {throw new IllegalStateException("We are using OpenGL!"); }
